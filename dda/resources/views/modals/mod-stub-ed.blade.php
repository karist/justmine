<!-- Modal -->
<div id="edStub" class="modal fade" role="dialog">
	<div class="modal-dialog">
	    ...
	    <div class="modal-content">
	    	<div class="modal-header">
	        	...
	        	<h4 class="modal-title">Edit Existing Stub</h4>
	    	</div>
	        ...
	        @endif
	      	...
	      	<div class="modal-footer">
	        	<button type="submit" class="btn btn-primary" id="stub_save" value="Save Stub">Save</button></form>
